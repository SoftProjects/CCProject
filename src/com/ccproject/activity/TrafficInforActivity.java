...
public class TrafficInforActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		final ImageView imageview = (ImageView)findViewById(R.id.traffic_map_image);
		
		loader.setBitmap(imageview, Data.instance(this).getMapUrl(),new Handler(){
			@Override
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.traffic_infor, menu);
		return true;
	}
    ...
    public void addListener(ImageView imageview){
    	imageview.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				intent.setDataAndType(Uri.fromFile(new File(Data.IMAGE_CACHE+ImageLoader.getBitmapName(Data.instance(TrafficInforActivity.this).getMapUrl()))), "image/*");
